...
# Bir e ticaret şirketi müşterilerini segmenterlere ayırıp bu segmentlere göre pazarlama stratejileri belirlemek istiyor.
...
# Faturadaki bir  ürünün toplam fiyatı
df["TotalPrice"] = df["Quantity"] * df["Price"]
# Faturanın toplam fiyatı
...
df.isnull().sum()
df.dropna(inplace=True) #Veri setindeki eksik değerleri silme işlemi.
...
############################################################
# 4. RFM METRİKLERİNİN HESAPLANMASI (CALCULATİNG RFM METRİCS)
############################################################
...
#######################################################
# 5. RFM SKORLARININ HESAPLANMASI (CALCULATİNG RFM SCORES)
#######################################################
...
######################################################
# 6. RFM SEGMENTLERİNİN OLUŞTURULMASI VE ANALİZ EDİLMESİ (CREATİNG & ANALYSIS RFM SEGMENTS)
#####################################################
